...
;(function($) {
  ...
  var Item = function( element, options ) {
    ...
    this.moveTo = function( x, y, scale ) {
      ...
      // var temp = document.querySelector('[ng-controller="GetapiCtrl"]');
      // var temp = angular.element(document.querySelector('[ng-controller="GetapiCtrl"]')).scope();
      // console.log(temp);
       // var temp = $('.failure').text();
       // var temp1 = $('.test').html();
       // console.log(temp1);
      ...
      //   }
        ...
        var item = $('#showcase').data("carousel").nearestItem().element.children
       var build_status = $.trim($(item).find('.temp1.ng-binding').text());
       ...
       // var build_status =  angular.element('[ng-app=alarm]').scope().build_status.map( function(item) {return (item.Status)});
      // console.log(build_status == "FAILURE");


    

      if(build_status == "FAILURE" || build_status == "UNSTABLE" || build_status == ""){
      // var audio = new Audio('iPhone_5-Boing-0.1-0.6.mp3');
      // audio.play();
      // } 
        
    //     $("<audio></audio>").attr({ 
    // 'src':"http://www.schillmania.com/projects/soundmanager2/demo/mpc/audio/CHINA_1.mp3", 
    // 'volume':0.0,
    // 'autoplay':'autoplay'
    //     });

$("<audio></audio>").attr({ 
    'src':'images/salami-alarm.mp3', 
    'volume':0.9,
    'autoplay':'autoplay'
        });
      }
